...
public class APIEndpoint {
    ...
    private boolean checkUrl(String URL) {
        String urlRegex = "^(http:\\/\\/www\\.|https:\\/\\/www\\." +
        "|http:\\/\\/|https:\\/\\/)?[a-z0-9]+([\\-\\.]"+
        "{1}[a-z0-9]+)*\\.[a-z]{2,5}(:[0-9]{1,5})?(\\/.*)?$";
        return Pattern.compile(this.urlRegex).matcher(URL).matches();
    }
    ...
    public APIEndpoint() {
        ...
        do {
            ...
            this.registrationAddress = sc.nextLine();
        ...
        do {
            ...
            this.connectionAddress = sc.nextLine();
